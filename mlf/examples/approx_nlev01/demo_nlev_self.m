...
for ii = 1:numel(pSpace)
    ...
    if SAVEIT; mlf.saveGIF(handler,ii,['ex_' num2str(2) '_min' num2str(min(pSpace)) 'max' num2str(max(pSpace)) ]); end
end
...
for ii = 1:numel(pSpace)
    ...
    drawnow, 
    if SAVEIT; mlf.saveGIF(handler,ii,['ex_eval_' num2str(2) '_min' num2str(min(pSpace)) 'max' num2str(max(pSpace)) ]); end
    if SAVEIT; mlf.figSavePDF(['figures/ex_eval_' num2str(2) '_min' num2str(min(pSpace)) 'max' num2str(max(pSpace)) '_' num2str(ii)],.5); end
end
